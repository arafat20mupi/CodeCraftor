...
import signupImage from "../../public/Group 2014.png";
import { AuthContext } from "../Provider/AuthProvider";
import SocialLogin from "./SocialLogin";
import { imageUpload } from "../Utility/imageUpload";

const SignUp = () => {
  const { createUser, updateProfileData , user} = useContext(AuthContext);
  const {
    register,
    handleSubmit,
    formState: { errors },
...
console.log(user)
  ...
  return (
    <div className="flex bg-gray-200 items-center justify-center min-h-screen p-4 mt-16">
