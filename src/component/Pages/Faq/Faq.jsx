        ...
        <div style={{borderRadius: '100px 100px 0px 0px'}} className='bg-gradient-to-r from-[#182E76] to-[#37233B]'>
            <div className="  container  mx-auto md:p-8 p-4  text-white">
                <div className="flex flex-col justify-center items-center text-center">
                    <h1 data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="50" className="text-4xl md:text-[58px] font-semibold leading-[68px] w-full md:w-[676px]">Have an Idea? Let's Build and Scale It!</h1>
                ...
                <div className="w-[90%] mx-auto">
                    <div className=" md:flex  gap-28 justify-center ">
                        ...
                        <div data-aos="fade-left" data-aos-duration="1800" className="space-y-4">
