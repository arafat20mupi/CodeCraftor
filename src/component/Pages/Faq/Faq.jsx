        ...
        <div style={{borderRadius: '100px 100px 0px 0px'}} className='bg-gradient-to-r from-[#182E76] to-[#37233B]'>
            <div className="  container  mx-auto md:p-8 p-4  text-white">
                <div className="flex flex-col justify-center items-center text-center">
                    <h1 className="text-4xl md:text-[58px] font-semibold leading-[68px] w-full md:w-[676px]">Have an Idea? Let's Build and Scale It!</h1>
                    <button className="btn my-8 md:my-28 w-full md:w-[164px] bg-gradient-to-r from-[#FF9A63] to-[#FE804B] text-white text-sm font-normal leading-6 ">
                        Book a demo
                    </button>
                </div>
                ...
                <div className="w-[90%] mx-auto">
                    <div className=" md:flex  gap-28 justify-center ">
                        <div>
                            <div className=""><h2 className="text-5xl md:text-6xl text-start font-semibold">Frequently Asked <br /> Questions</h2></div>
