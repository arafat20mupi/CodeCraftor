...
export default function ProjectShowcase() {
    return (
        <div data-aos="fade-up" data-aos-duration="2000" className="flex flex-col md:flex-row items-center justify-between p-4 md:p-8 lg:p-28 bg-gray-100">
            {/* Left Section */}
            <div data-aos="fade-up" data-aos-duration="2500" className="md:w-1/2 w-full text-center md:text-left mb-8 md:mb-0">
            ...
            <div data-aos="fade-up" data-aos-duration="2500" className="md:w-1/2 w-full">
                <Swiper
